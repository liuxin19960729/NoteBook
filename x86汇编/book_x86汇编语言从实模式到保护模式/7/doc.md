...
-3 
  8 bits: 1111 1101 
  16bits: 1111 1111 1111 1101
  32bits: .....



cbw (covert byte to word) cwd (covert word to double word) 指令
cbw 将 AL 中的有符号数扩展到整个AX
例如:
   al:0100 1111
   cbw
   ax:1111 1111 0100 1111
  ...
  cwd:
    ...
    dx:ax
    0000 0000 0000 0000 :  0100 1111 0111 1001 




  ax: 1000 1101 1000 1011
  cwd
  dx:ax

  1111 1111 1111 1111 : 1000 1101 1000 1011
...
## 7.8 数位的显示
```
Intel 8086 只允许以下几种基地址寄存器和变址寄存器组合
  [bx+si]
  [bx+di]
  [bp+si]
  [bp+di]
